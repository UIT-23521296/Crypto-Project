...
# Chờ file từ chall mount ra
while not os.path.exists("/output/encrypt_1.enc"):
    print("[*] Waiting for encrypt_1.enc to be generated by chall...")
    time.sleep(2)

# Sau khi file tồn tại, chờ thêm chút để đảm bảo ghi xong
time.sleep(1)
